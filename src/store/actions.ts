...
export function editTodo(todoId: string, message: string): EditTodoAction {
  return {
    type: EDIT_TODO,
    payload: {
      todoId,
...
///////////
export interface EditAbleTodoAction {
  type: typeof EDITABLE_TODO;
  payload: string;
}

export function EditAbleTodo(todoId: string): EditAbleTodoAction {
  return {
    type: EDITABLE_TODO,
    payload: todoId,
  };
