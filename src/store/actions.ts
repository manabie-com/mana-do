...
export function filterTodo(status: string): FilterTodoAction {
    return {
        type: FILTER_TODO,
        payload: status,
    };
...
export interface UpdateTodoAction {
    ...
    payload: { content: string; todoId: any };
}

export function updateTodo(content: string, todoId: any): UpdateTodoAction {
    return {
        type: UPDATE_TODO,
        payload: { content, todoId },
    };
}
