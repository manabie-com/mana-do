...
////// Edit feature
export const SELECT_EDIT_TODO = 'EDIT_TODO';
export const EDITED_TODO = 'EDITED_TODO';

export interface SelectTodoEditAction {
    type: typeof SELECT_EDIT_TODO,
    payload: string
}

export interface EditedTodoAction {
    type: typeof EDITED_TODO,
    payload: {
        todoId: string
        newValue: string
    }
...
export function selectTodoEdit(todoId: string): SelectTodoEditAction {
    return {
...
export function editedTodo(todoId: string, newValue: string): EditedTodoAction {
    return {
        type: EDITED_TODO,
        payload: {
            todoId,
