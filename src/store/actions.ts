...
import { SetTodoAction, CreateTodoAction, UpdateTodoStatusAction, DeleteTodoAction, DeleteAllTodosAction, ToggleAllTodosAction, EditTodoAction, FilterToDosAction } from './types';
...
export const updateToDoStatus = (todoId: string, checked: boolean):UpdateTodoStatusAction => {
  return {
...
export const filterToDos = (filter: EnhanceTodoStatus | 'ALL'):FilterToDosAction => {
  return {
    type: FILTER_TODOS,
    payload: { filter }
  };
