import {EnhanceTodoStatus, Todo} from "../models/todo";
...
export const FILTER_TODO_STATUS = 'FILTER_TODO_STATUS';
...
///////////
export interface FilterStatusAction {
  type: typeof FILTER_TODO_STATUS,
  payload: EnhanceTodoStatus
}

export function setTodoStatus(status: EnhanceTodoStatus): FilterStatusAction {
  return {
