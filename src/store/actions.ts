...
export const CHANGE_TODO_MODE = 'CHANGE_TODO_MODE';
...
//////////////
export interface ChangeTodoMode {
  type: typeof CHANGE_TODO_MODE,
  payload: {
    todoId: string,
    isEditing: boolean
  }
...
export function changeTodoMode(todoId: string, isEditing: boolean): ChangeTodoMode {
  return {
