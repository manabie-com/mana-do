...
//todoId here was declared as a string, then it gives an error, I updated it to number
export function updateTodoStatus(todoId: number, checked: boolean): UpdateTodoStatusAction {
    return {
...
export function updateTodoName(todoId: number, todoName: string): UpdateTodoNameAction {
    return {
