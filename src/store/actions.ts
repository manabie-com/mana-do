...
//////////////
export interface UpdateEditingStatusAction {
  type: typeof UPDATE_TODO_EDITING,
  payload: {
    todoId: string,
...
export function updateEditingStatus(todoId: string, isBeingEdited: boolean): UpdateEditingStatusAction {
  return {
